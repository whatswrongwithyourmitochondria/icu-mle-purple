...
SYSTEM_PROMPT = dedent(
    ...
    - For images/audio/text: prefer extracting features from a frozen pretrained model
      (e.g. ResNet/EfficientNet via timm, DistilBERT via transformers) then training
      a fast classifier (LightGBM, LogReg) on top. Fine-tuning large models is slow
