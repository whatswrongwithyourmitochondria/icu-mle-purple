...
This repository contains a purple agent for the AgentBeats competition, focused on the MLE-bench Research Track.
...
This implementation is not a single-shot code generator. It combines search, diversity, and safety mechanisms:
...
- UCB-style branch selection: branch expansion uses exploration/exploitation tradeoff (inspired by Monte-Carlo graph/tree search ideas).
